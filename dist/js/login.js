...
var config = {
  ...
  messageUrl: '/NIM_Web_Demo_H5/index.html#/message',
  succeedUrl: '/NIM_Web_Demo_H5/index.html#/succeed',
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(/*! ./../../webpack/buildin/global.js */ 22), __webpack_require__(/*! ./../../timers-browserify/main.js */ 68).setImmediate))
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(/*! ./../webpack/buildin/global.js */ 22), __webpack_require__(/*! ./../process/browser.js */ 23)))
...
var formData = new _vue2.default({
  ...
  methods: {
    login: function login() {
      ...
      var regist = JSON.parse(localStorage.getItem("regist"));
      if (!regist) {
        alert('该账号还没注册，先去注册');
        return false;
      }
      var yy = true;
      var isOk = regist.map(function (elem, index) {
        if (elem['account'] == this.account && elem['password'] == sdktoken) {
          alert('登录成功');
          location.href = _configs2.default.messageUrl;
          yy = false;
          return false;
        }
      }.bind(this));
